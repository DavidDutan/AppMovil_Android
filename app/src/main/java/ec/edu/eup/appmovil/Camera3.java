...
public class Camera3 extends CameraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(Camera3.this, Manifest.permission.RECORD_AUDIO)
                == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(Camera3.this, new String[]{Manifest.permission.RECORD_AUDIO},Mis_Permisos);

        }

        if (ContextCompat.checkSelfPermission(Camera3.this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(Camera3.this, new String[]{Manifest.permission.CAMERA}, Mis_Permisos);

        }

        if (ContextCompat.checkSelfPermission(Camera3.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(Camera3.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, Mis_Permisos);

        }

        if (ContextCompat.checkSelfPermission(Camera3.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(Camera3.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, Mis_Permisos);
        ...
        gallery.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_UP){
                    ...
                    startActivity(new Intent(Camera3.this, GalleryActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
                    return true;
                }
                return false;
            }
        ...
        cameraBridgeViewBase.setCvCameraViewListener(new CameraBridgeViewBase.CvCameraViewListener2(){
            ...
            public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
                ...
                DeteccionBordes(entradaFrame,salidaFrame);
    ...
    public native void DeteccionBordes(Bitmap in, Bitmap out);
